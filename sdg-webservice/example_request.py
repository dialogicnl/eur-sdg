...
data = {"data":["Globally, the number of people living in extreme poverty declined from 36 per cent in 1990 to 10 per cent in 2015. ",
...
res = requests.post('http://192.168.0.99:5000/sdg', json=data)
print(res.json())